...
public class auxilio {
	...
	public static void main(String[] args) {
		...
		if (chefaFamilia && naoOutroAuxilio) {
			System.out.printf(
					"Ola Sr%c. vai receber de auxilio R$ %.2f, mais R$ %.2f do(s) filho(s) gerando um total de R$ %.2f.",
					pronome, (AUXILIO * 2), (VALORFILHO * filhos), ((AUXILIO * 2) + (VALORFILHO * filhos)));
		} else if (naoOutroAuxilio) {
			System.out.printf(
					"Ola Sr%c. vai receber de auxilio R$ %.2f, mais R$ %.2f do(s) filho(s) gerando um total de R$ %.2f.",
					pronome, AUXILIO, (VALORFILHO * filhos), (AUXILIO + (VALORFILHO * filhos)));
		} else {
